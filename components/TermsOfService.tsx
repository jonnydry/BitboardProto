  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-6 animate-fade-in font-mono text-terminal-text">
      ...
      <section className="space-y-4">
        ...
        <p>
          By accessing and using BitBoard, you accept and agree to be bound by these Terms of
      ...
      <section className="space-y-4">
        ...
        <p>
          BitBoard is a decentralized message board application built on the Nostr protocol. It is
          provided as open-source software and operates as a client-side only application with no
          backend servers.
        </p>
      ...
      <section className="space-y-4">
        ...
        <p>When using BitBoard, you agree to:</p>
        <ul className="list-disc list-inside space-y-2 ml-4">
      ...
      <section className="space-y-4">
        ...
        <p>
          BitBoard is open-source software. The source code is available under the terms of its
          license (see GitHub repository).
        </p>
        <p>Content you post to the Nostr network:</p>
        <ul className="list-disc list-inside space-y-2 ml-4">
      ...
      <section className="space-y-4">
        ...
        <p>
          BitBoard is provided "AS IS" without warranties of any kind, either express or implied,
        ...
        <p>BitBoard interfaces with the decentralized Nostr protocol. We do not control:</p>
        <ul className="list-disc list-inside space-y-2 ml-4">
      ...
      <section className="space-y-4">
        ...
        <p>
          BitBoard may integrate with third-party services (Nostr relays, AI services, error
          tracking). Your use of these services is subject to their respective terms and privacy
          policies.
        </p>
      </section>
      ...
      <section className="space-y-4">
        ...
        <p>You may stop using BitBoard at any time by:</p>
        <ul className="list-disc list-inside space-y-2 ml-4">
      ...
      <section className="space-y-4">
        ...
        <p>
          You agree to indemnify and hold harmless BitBoard and its contributors from any claims,
      ...
      <section className="space-y-4">
        ...
        <p>
          ...
          immediately upon posting. Your continued use of BitBoard after changes constitutes
      ...
      <section className="space-y-4">
        ...
        <p>
          For questions about these Terms of Service, you can reach out through the Nostr network or
